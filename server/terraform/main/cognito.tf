...
resource "aws_cognito_user_pool" "pool" {
    ...
    lifecycle {
      ignore_changes = [ password_policy, lambda_config ]
    }
}
...
resource "aws_cognito_user_pool_client" "client" {
    ...
    read_attributes = ["email", "family_name", "given_name", "phone_number", "phone_number_verified", "profile", "custom:race", "custom:sex"]
    write_attributes = ["email", "family_name", "given_name", "phone_number", "profile", "custom:race", "custom:sex"]
}
