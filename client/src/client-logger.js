/**
 * TODO This is the same as ../../common/logger, except that it uses
 * sprintf rather than util.format, since util.format doesn't work
 * on the renderer/browser side without irritating polyfills. If this
 * works out with sprintf we should replace util.format with sprintf
 * in ../../common/logger and just import that here.
 * 
